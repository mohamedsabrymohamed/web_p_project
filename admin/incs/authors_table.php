<?php 
    class authors_table
    {
		...
		public function retrieve_all_authors()
		{
		...
		public function retrieve_authors_by_id($authors_id)
		{
		   $query = "SELECT * from ".$this->_table_name." where id ='".$authors_id."'";
            $result = $this->_dbh->query($query);
