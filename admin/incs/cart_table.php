<?php 
    class cart_table
    {
		...
		public function retrieve_cart_by_user_id($user_orders_id)
		{
        ...
        public function retrieve_cart_item_by_id($user_orders_id)
        {
        ...
        public function delete_data_by_user_id($productid)
        {
            $product_id = $productid;
